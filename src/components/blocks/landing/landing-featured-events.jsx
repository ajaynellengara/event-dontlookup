  ...
  return (
    <section className="w-full h-auto bg-[#121212] block">
      <div className="container">
        ...
        <div className="flex flex-wrap md:-mx-4 lg:-mx-6 xl:-mx-8 md:[&>div]:px-4 lg:[&>div]:px-6 xl:[&>div]:px-8 2xl:-mx-10 2xl:[&>div]:px-10 3xl:-mx-12 3xl:[&>div]:px-12">
          ...
          <div className="w-full sm:w-9/12">
            <div className="flex flex-wrap -mx-2 sm:-mx-2 md:-mx-4 lg:-mx-6 xl:-mx-8 2xl:-mx-10 3xl:-mx-12 [&>div]:p-2 sm:[&>div]:p-2 md:[&>div]:p-4 lg:[&>div]:p-6 xl:[&>div]:p-8 2xl:[&>div]:p-10 3xl:[&>div]:p-12">
              {data?.items?.map((item, index) => (
                <div key={item?.id}
                  className="w-full 3xs:w-1/2 2xs:w-1/3 sm:w-1/3">
                  <div className="w-full h-auto block">
                    <div className="w-full rounded-[8px] aspect-[396/510] overflow-hidden mb-3 md:mb-3.5 lg:mb-4 xl:mb-4 2xl:mb-5 3xl:mb-6">
                      <Image
                        src={item?.media?.url}
                        alt={item?.media?.alt}
                        width={400}
            ...
            <div className="w-full h-[1px] bg-[#767676]" />
          </div>
        </div>
      </div>
    </section>
