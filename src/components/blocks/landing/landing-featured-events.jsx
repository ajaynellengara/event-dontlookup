...
function EventCard({ item }) {
  return (
    ...
    <div className={cn("group w-full h-auto block hover:bg-[#3a3a3a]/10 border border-[#3a3a3a] sm:border-[#121212] p-2 sm:p-2 md:p-4 lg:p-6 xl:p-8 2xl:p-10 3xl:p-12 rounded-[8px] transition-all duration-300 sm:hover:[&>div]:scale-105",
