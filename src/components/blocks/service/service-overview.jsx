  ...
  return (
    <section className="w-full h-auto block relative z-0 py-[30px] sm:py-[40px] xl:py-[90px] 2xl:py-[100px] 3xl:py-[120px] bg-white">
      <div className="container">
        <div className="flex flex-wrap sm:items-center -mx-4 xl:-mx-7 2xl:-mx-8 3xl:-mx-11 [&>*]:p-4 xl:[&>*]:p-7 2xl:[&>*]:p-8 3xl:[&>*]:p-11">
          <div className="w-full md:w-5/12 lg:w-[52%]">
            <Image
          ...
          <div className="w-full flex flex-wrap items-center md:w-[7/12] lg:w-[48%] pt-[20px] md:pt-0 md:pl-[30px] xl:pl-[50px] 2xl:pl-[60px] 3xl:pl-[80px] relative">
            <Heading
              as="h3"
              size="h3"
            ...
            <Text as="div" size="p1" className="font-light text-black max-w-[80%]">
              {data?.description &&
