...
export default function ServiceApproachCard({ data, locale, index }) {
  return (
    <div className="group w-full h-full min-h-[220px] xl:min-h-[310px] 2xl:min-h-[350px] 3xl:min-h-[420px]  relative z-0 transition-transform duration-300 ease-out hover:scale-y-[1.1]">
      ...
      <div
        className={cn(
          "group w-full h-full px-5 pt-2.5 pb-7 xl:px-5 xl:pt-2.5 xl:pb-7 2xl:px-8 2xl:pt-4 2xl:pb-10 flex flex-wrap justify-between relative",
          index % 2 === 0 ? "bg-[#FFFBF2]" : "bg-[#FAFAFA]",
        )}
      >
        <div
          className={cn(
            "text-[28px] sm:text-[60px] md:text-[80px] xl:text-[100px] 2xl:text-[120px] 3xl:text-150px] font-light leading-none opacity-50 bg-clip-text text-transparent",
