    ...
    <section className="w-full py-[30px] sm:py-[40px] xl:py-[70px] 2xl:py-[100px] bg-[#fffbf2] overflow-hidden">
      <div className="container">
        ...
        <div className="relative">
          ...
          <button
            onClick={goToNext}
            className="w-[80px] sm:w-[100px] xl:w-[130px] 2xl:w-[160px] absolute z-0 bottom-0 right-4"
          >
            <div className="w-full h-full bg-[url('/images/home-portfolio-button-1.svg')] bg-center bg-no-repeat bg-size-[40px] xl:bg-size-[45px] 2xl:bg-size-[50px] relative hover:bg-size-[100px] transition-all duration-300">
              <Image
