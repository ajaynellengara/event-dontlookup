  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-[10px] sm:text-[12px] font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:scale-105 active:scale-95",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-[#1e1e1e] border border-[#cda278] bg-none hover:bg-[#cda278] hover:text-white hover:shadow-lg dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
      ...
      size: {
        ...
        lg: "text-[12px] 2xl:text-[14px] 3xl:text-[18px] leading-none font-normal h-8 xl:h-8 2xl:h-10 3xl:h-12 rounded-[6px] 2xl:rounded-[8px] px-4 has-[>svg]:px-2",
