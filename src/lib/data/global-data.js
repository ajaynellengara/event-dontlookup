export const globalData = {
    seo: {
        title: "DontLookupFashion.Events",
        description: "Beyond events. Beyond borders. Beyond the runway.",
        keywords: "fashion, events, dubai, fashion shows, models",
        meta: { themeColor: "#000000" }
    },
    header: {
